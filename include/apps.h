...
#define BAMOCAR_SCALE_FACTOR 0.2
#define Convert_To_BAMOCAR_Scale(x) ((BAMOCAR_MAX * BAMOCAR_SCALE_FACTOR) - (x * (BAMOCAR_MAX * BAMOCAR_SCALE_FACTOR) / APPS_1_UPPER_BOUND))
